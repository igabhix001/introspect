...
// Lazy-load Sheet (Radix Dialog) — only needed when mobile menu opens
        ...
        <nav className="flex items-center justify-between">
          ...
          <Link href="/" prefetch={false} className="flex items-center gap-2 group">
            <Image
              ...
              width={40}
              height={40}
              className="object-contain transition-transform duration-300 group-hover:scale-105 h-9 w-9 sm:h-10 sm:w-10"
              priority
            />
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            {/* Mobile Menu */}
            <Suspense fallback={<button className="lg:hidden p-2 rounded-lg hover:bg-muted cursor-pointer" aria-label="Open menu"><Menu className="h-5 w-5" /></button>}>
