...
import { ArrowRight, Shield, TrendingUp, Target, Brain, Trophy, FileText, Check, AlertTriangle, Smile } from "lucide-react";
import { AuroraBackground } from "@/components/ui/aurora-background";
import { ParticleField } from "@/components/ui/particle-field";
import { TextReveal } from "@/components/ui/text-animations";
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-8 items-center">
            ...
            <div className="max-w-2xl">
              ...
              <h1 className="font-heading text-4xl sm:text-5xl lg:text-6xl xl:text-7xl font-extrabold tracking-tight leading-[1.05] mt-8 mb-4">
                <TextReveal text="Stop Blowing" delay={0.3} />
                <br />
                <span className="gradient-text">
                  <TextReveal text="Accounts" delay={0.6} />
                </span>
              </h1>
              ...
              <motion.h2
                ...
                className="text-lg sm:text-xl md:text-2xl font-bold text-success mb-6 font-heading"
              >
