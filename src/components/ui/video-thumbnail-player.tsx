  ...
  (
    ...
    return (
      <>
        ...
        {isModalOpen && (
          <div
            className="fixed inset-0 z-50 flex animate-in fade-in-0 items-center justify-center bg-black/90 backdrop-blur-sm"
            aria-modal="true"
            role="dialog"
          ...
          >
            ...
            <button
              ...
              className="absolute right-4 top-4 sm:right-8 sm:top-8 z-[60] rounded-full bg-white/10 p-3 text-white transition-colors hover:bg-white/20 hover:scale-110"
            ...
            {/* Video Iframe */}
            <div 
              className="w-full max-w-5xl aspect-video p-4 z-50 relative"
            ...
            >
               <iframe
                    ...
                    allowFullScreen
                    className="h-full w-full rounded-2xl shadow-[0_0_50px_rgba(0,0,0,0.5)] border border-white/10"
                ></iframe>
            </div>
          </div>
        )}
