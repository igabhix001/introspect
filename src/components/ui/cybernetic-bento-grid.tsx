...
const BentoItem = ({ className, children }: { className?: string, children: React.ReactNode }) => {
    ...
    return (
        <div 
          ref={itemRef} 
          className={cn(
            "relative overflow-hidden rounded-2xl border border-white/10 bg-black/40 p-6 backdrop-blur-md transition-colors hover:border-white/20 hover:bg-black/60",
            className
          )}
        >
...
export const CyberneticBentoGrid = () => {
    return (
        <div className="w-full bg-black py-24 relative overflow-hidden" id="features">
            {/* Background grids */}
            <div className="absolute inset-0 bg-[linear-gradient(to_right,#4f4f4f2e_1px,transparent_1px),linear-gradient(to_bottom,#4f4f4f2e_1px,transparent_1px)] bg-[size:14px_24px] [mask-image:radial-gradient(ellipse_60%_50%_at_50%_0%,#000_70%,transparent_100%)]"></div>
            
            <div className="mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-8 relative z-10">
                <div className="text-center mb-16">
                    <span className="inline-block text-sm font-semibold tracking-widest uppercase text-success mb-4 text-emerald-500">
                        INTROSPECT™ FEATURES
                    </span>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 auto-rows-[minmax(200px,auto)]">
                    ...
                    <BentoItem className="lg:col-span-2 lg:row-span-2 group">
                        <div className="flex-1">
                            ...
                            <div className="mt-8 flex gap-4 text-sm font-bold tracking-wider uppercase">
                                ...
                                <span className="flex items-center gap-2 text-gray-400 bg-gray-500/10 px-4 py-2 rounded-full border border-gray-500/20">⚪ No Trade</span>
                            </div>
                        </div>
                    </BentoItem>

                    <BentoItem>
                        <h3 className="text-xl font-bold text-white mb-2">Position Sizing Framework</h3>
                    ...
                    <BentoItem>
                        <h3 className="text-xl font-bold text-white mb-2">Risk per Trade</h3>
                        <p className="text-gray-400 text-sm leading-relaxed">
                    ...
                    <BentoItem className="lg:row-span-2 flex flex-col justify-between">
                        <div>
                            <h3 className="text-xl font-bold text-white mb-2">Behavior Analytics</h3>
                            <p className="text-gray-400 text-sm leading-relaxed mb-4">
                                Self-assessment framework to identify emotional patterns in your trading journal.
                            </p>
                            <p className="text-emerald-400 text-sm font-medium">Catch revenge trading, FOMO, and hesitation before they become habits.</p>
                        </div>
                    </BentoItem>

                    <BentoItem className="lg:col-span-2">
                        <h3 className="text-xl font-bold text-white mb-2">Accountability Challenge</h3>
